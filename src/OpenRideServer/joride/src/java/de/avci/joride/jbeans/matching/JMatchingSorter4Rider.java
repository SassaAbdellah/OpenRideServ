 ...
 * 
 * 1) matches accepted by Driver 2) matches accepted by Rider 3) The rest sorted
 * by pickup Date
 * 
 * @author jochen
 * 
 */
public class JMatchingSorter4Rider implements Comparator<JMatchingEntity> {
	...
	public int compare(JMatchingEntity o1, JMatchingEntity o2) {
		...
		// Driver State comparison comes next
