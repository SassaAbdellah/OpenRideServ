-- ------------------------------------------------------
-- routing graph table for mapsforge. 
-- found at: http://mapsforge.googlecode.com/svn-history/r1713/branches/weights-turn-restrictions/mapsforge/src/org/mapsforge/preprocessing/routingGraph/graphCreation/graphAdapter/createTables.sql
--
--
--
--
...
DROP TABLE IF EXISTS dummy_edge;
DROP TABLE IF EXISTS dummy_node;
DROP TABLE IF EXISTS old_from_target;
...
CREATE TABLE rg_edge( 
	...
	target_id INTEGER NOT NULL,
        --
        -- 
        -- not null constraint for "weight" was found to kill creation of the routing graph, so dropped by JL
	...
	osm_way_id BIGINT NOT NULL,
 	name VARCHAR NOT NULL,
        -- 
        -- 
        -- not null constraint for "ref" was found to kill creation of the routing graph, so dropped by JL
	...
	urban BOOLEAN NOT NULL,
        --
        -- 
        -- not null constraint for "roundabout" was found to kill creation of the routing graph, so dropped by JL
        -- ref  VARCHAR NOT NULL,
...
CREATE TABLE turn_restrictions(
	id INTEGER NOT NULL,
	osm_ralation_id BIGINT NOT NULL,
